...
export default function License() {
  const { socialmediaLinkData } = useSiteMetaData()
  return (
    <main>
      <Header/>
      ...
      <section class="mt-20 mb-10">
        <div className="text-center align-content-center">
          <img class="h-auto w-20 ml-auto mr-auto mb-10" src={Logo} alt="Adam McKnight Typemark"/>
            <h1 class="heading-text pl-24 pr-24 w-50%" dangerouslySetInnerHTML={{ __html: socialmediaLinkData.header }}></h1>
        </div>
      </section>

      <section class="mt-10 mb-32">
        <div className="text-justify align-content-center">
          <a href={socialmediaLinkData.linkOne}  class="about-header mt-52 ml-9 mb-10 h-auto w-4/5 lg:w-2/4 ml-auto mr-auto" dangerouslySetInnerHTML={{__html: socialmediaLinkData.linkOneTitle}}></a>
        </div>
      </section>
